 ...
 * 
 * 풀고나서 아쉬운점
 * 1. 문자열 파싱 과정에서 정규식을 사용하여 더 간결하게 처리할 수 있었을 것 같습니다. // s.substring(2, s.length() - 2).split("\\},\\{") 처럼 한줄로 처리할 수 있었을 것 같습니다. 
 * 2. int[] answer = new int[answer.size()]; 부분으로 처리 후, groups를 index로 접근하여 처리할 수 있었을 것 같습니다. 
